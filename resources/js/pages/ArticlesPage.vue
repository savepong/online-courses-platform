<template>
  <div>
    <div class="course-dhashboard topic2"></div>
    <!-- <div class="hero-feature-bg uk-visible@s"></div> -->
    <div class="uk-container uk-visible@s">
      <div class="uk-container">
        <div class="uk-position-relative uk-margin-small-top none-border uk-clearfix">
          <div class="uk-float-left">
            <h1 class="uk-text-light">บทความ</h1>
            <h3 class="uk-margin-remove uk-text-light">แนะนำ</h3>
          </div>
    ...
    <div class="uk-container uk-margin-top">
      <h3 class="uk-margin-remove uk-text-light">ล่าสุด</h3>
      <div
